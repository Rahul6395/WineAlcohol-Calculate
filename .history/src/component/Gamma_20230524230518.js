...
const GammaTable = () => {
    ...
    //   Mode
      ...
      let red = [] ;
      const statsByClass = Object.entries(gammaByClass).map(([className, gammaValues]) => {console.log("className ",className )})
console.log("statsByClass ",red )
